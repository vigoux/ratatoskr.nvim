local _0_0 = nil
do
  local name_0_ = "ratatoskr.aniseed.test"
...
local function _1_(...)
  _0_0["aniseed/local-fns"] = {require = {a = "ratatoskr.aniseed.core", nvim = "ratatoskr.aniseed.nvim", str = "ratatoskr.aniseed.string"}}
  return {require("ratatoskr.aniseed.core"), require("ratatoskr.aniseed.nvim"), require("ratatoskr.aniseed.string")}
end
local _2_ = _1_(...)
local a = _2_[1]
local nvim = _2_[2]
